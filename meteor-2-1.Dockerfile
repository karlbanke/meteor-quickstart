...
ARG NODE_VERSION
ENV NODE_VERSION ${NODE_VERSION:-12.20.1}
...
ARG METEOR_VERSION
ENV METEOR_VERSION ${METEOR_VERSION:-2.1}

ONBUILD ARG NPM_USER
ONBUILD ENV NPM_USER $NPM_USER

ONBUILD ARG NPM_PASS
ONBUILD ENV NPM_PASS $NPM_PASS

ONBUILD ARG NPM_EMAIL
ONBUILD ENV NPM_EMAIL $NPM_EMAIL
